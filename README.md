...
*LLLL_sched_#* are MATLAB matrices and CSV's containing corresponding smart-home feature (i.e., lights) time-series data utilized for the machine learning component of Predi-Home.
